/* =========================================================
   INTERRIORS — variation 3 "Glass Duotone" script
   Adds: mouse-tilt effect on glass cards ([data-tilt]),
   glass-stepper scroll-fill (roadmap). Core UX kept from original.
   ========================================================= */
(function () {
  'use strict';
  ...
  function onScroll() {
    ...
    var offset = (header ? header.offsetHeight : 84) + 50;
    var current = null;
  ...
  function scrollToTarget(target) {
    var headerH = header ? header.offsetHeight : 84;
    var rect = target.getBoundingClientRect();
    var top = rect.top + window.pageYOffset - headerH - 16;
  ...
  /* --------------------------------------------------
     NEW: Mouse-tilt effect for glass cards
  -------------------------------------------------- */
  ...
  /* --------------------------------------------------
     NEW: Glass stepper scroll-fill (roadmap progress line)
  -------------------------------------------------- */
  var stepperSection = document.getElementById('roadmap');
  var stepperFill = document.getElementById('glass-stepper-fill');
  function updateStepperFill() {
    if (!stepperSection || !stepperFill) return;
    var rect = stepperSection.getBoundingClientRect();
    var viewportH = window.innerHeight;
    var total = rect.height;
    var visibleTop = viewportH * 0.7;
